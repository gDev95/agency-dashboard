...
import LabelWrapper from "../styled-components/LabelWrapper";
...
import { Label, Rider } from "../../../models/Artist/Artist.model";
import ButtonWrapper from "../styled-components/ButtonWrapper";
...
const AdvancedInformatioFormGroup = (props: Props) => {
...
export default AdvancedInformatioFormGroup;
